...
// Reviews New
router.get("/new", middleware.loggedIn, middleware.checkReviewExistence, function (req, res) {
...
// Reviews Create
router.post("/", middleware.loggedIn, middleware.checkReviewExistence, function (req, res) {
